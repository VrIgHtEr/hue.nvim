        ...
        pickers.new(opts, {
            ...
            attach_mappings = function(prompt_bufnr)
                actions.select_default:replace(function()
                    ...
                    rest.request_async(hue.constants.url_resources.grouped_light .. '/' .. group.data.group.id, {
                        method = 'PUT',
                        headers = { ['hue-application-key'] = hue.constants.appkey, ['Content-Type'] = 'application/json' },
